...
const YourComponent = () => {
  ...
  const handleFormSubmit1 = (event) => {
    ...
    Axios.post("http://localhost:3031/create", formData1)
    .then((response) => {
  ...
  const handleFormSubmit2 = (event) => {
    ...
    Axios.post("http://localhost:3031/upload", formData2)
    .then((response) => {
      // Handle the response, e.g., show a success message
    })
    .catch((error) => {
  ...
  const handleFormSubmit3 = (event) => {
    ...
    Axios.post("http://localhost:3031/recreate", formData3)
    .then((response) => {
      // Handle the response, e.g., show a success message
    })
    .catch((error) => {
                        ...
                        <tr>
                          ...
                          <th>
                            <input
                              ...
                              name="pp2"
                              value={formData1.pp2}
                              onChange={(e) => setFormData1({ ...formData1, pp2: e.target.value })}
                            />
                          </th>
                        </tr>
                        <tr>
                          ...
                          <th>
                            <input
                              ...
                              name="pp3"
                              value={formData1.pp3}
                              onChange={(e) => setFormData1({ ...formData1, pp3: e.target.value })}
                            />
                          </th>
                        </tr>
                      </tbody>
