...
const YourComponent = () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    setPreviewImage({
      imgpp1: selectedFiles.imgpp1 ? selectedFiles.imgpp1.name : "None",
      imgpp2: selectedFiles.imgpp2 ? selectedFiles.imgpp2.name : "None",
      imgpp3: selectedFiles.imgpp3 ? selectedFiles.imgpp3.name : "None",
    });
