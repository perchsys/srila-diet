...
const Hypertensionlogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    if (user) {
      ...
      if (user.role === 'hypertension') {
        navigate('/hypertension'); // Replace '/admin' with your admin page route
      }
    } else {
      ...
      <div className="login-box">
        ...
        <div className="cart">
          <div className="card-body login-card-body">
            <p className="login-box-msg">Sign in as Hypertension patient</p>
...
export default Hypertensionlogin;
