...
const Obesitylogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    if (user) {
      ...
      if (user.role === 'obesity') {
        navigate('/obesity'); // Replace '/admin' with your admin page route
      }
    } else {
      ...
      <div className="login-box">
        ...
        <div className="cart">
          <div className="card-body login-card-body">
            <p className="login-box-msg">Sign in as obesity patient</p>
