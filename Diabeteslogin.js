...
const Diabeteslogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    if (user) {
      ...
      if (user.role === 'diabetes') {
        navigate('/diabetes'); // Replace '/admin' with your admin page route
      }
    } else {
      ...
      <div className="login-box">
        ...
        <div className="cart">
          <div className="card-body login-card-body">
            <p className="login-box-msg">Sign in as Diabetes patient</p>
